export const LABELS = {
  ...
  AUTH: {
    LOGIN_MODAL: {
      ...
      SIGNUP_LOADING_TEXT: 'Creating account...',
      RESET_LOADING_TEXT: 'Sending reset email...',
      ERROR_MESSAGE: 'Invalid email or password',
      CLOSE_BUTTON: '×',
      SIGNUP_TITLE: 'Create Account',
      SIGNUP_SUBTITLE: 'Join the DSD community',
      ...
      RESET_SUCCESS_MESSAGE: 'Password reset email sent! Check your inbox.',
